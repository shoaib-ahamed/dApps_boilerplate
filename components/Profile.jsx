    ...
    <div>
        ...
        <div>
            <form onSubmit={handleSubmit} className="grid justify-between align-middle mt-2">
                <div className="form-group flex justify-between align-middle w-96">
                    <p>Set a username : </p>  
                    <input type="text" className="form-control border-2 w-15 rounded-md p-1" name="username" value={userName} placeholder="ex. themonstarcar" onChange={handleChangeInput}></input>
                </div>
